...
GRAPH_FEATURE_FIELDS = (NODES, EDGES, GLOBALS, OBS, Q,
                        ACT, LEDGES, HEDGES, HNODES, LNODES)
# ,HNODES,LNODES)
GRAPH_INDEX_FIELDS = (RECEIVERS, SENDERS, LRECEIVERS,
                      LSENDERS, HRECEIVERS, HSENDERS)
GRAPH_DATA_FIELDS = (NODES, EDGES, RECEIVERS, SENDERS, GLOBALS, OBS, Q, ACT,
                     LEDGES, HEDGES, LRECEIVERS, LSENDERS, HRECEIVERS, HSENDERS, HNODES, LNODES)
# ,LNODES,HNODES)
GRAPH_NUMBER_FIELDS = (N_NODE, N_EDGE, N_HEDGE)
ALL_FIELDS = (NODES, EDGES, RECEIVERS, SENDERS, GLOBALS, N_NODE, N_EDGE, OBS, Q, ACT,
              LEDGES, HEDGES, LRECEIVERS, LSENDERS, HRECEIVERS, HSENDERS, N_HEDGE, LNODES, HNODES)
# ,LNODES,HNODES)
